...
import com.eminem.weibo.adapter.AttentionListAdapter;
...
public class MyAttentionActivity extends BaseActivity {
    ...
    private void initData() {
        RetrofitService.getService(BaseService.class).getAttention(BaseApplication.getContext().currentUser.getIdstr()).subscribeOn(Schedulers.io())
    ...
    private void initView() {
        adapter = new AttentionListAdapter(this, users);
