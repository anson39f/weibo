...
import com.xds.weibo.utils.DateUtils;
...
import static com.xds.weibo.R.id.tv_message_details;
...
public class MessageDetailsAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (pic_urls == null) {
            Glide.with(context).load(quoteAvatar).apply(new RequestOptions().placeholder(R.drawable.head_pistion)).into(holder.iv_message);
        } else {
            Glide.with(context).load(quoteBmiddlePic).apply(new RequestOptions().placeholder(R.drawable.head_pistion)).into(holder.iv_message);
        }
